        ...
        <div className="text-center mb-8">
          <Link href="/">
            <div className="inline-flex items-center gap-2 cursor-pointer mb-4">
              ...
              <span className="font-serif text-2xl font-semibold text-foreground">Inkwell</span>
            </div>
          </Link>
          <p className="text-muted-foreground text-sm">Join Inkwell and start sharing your ideas.</p>
        </div>

        <div className="bg-card border border-card-border rounded-2xl p-8 shadow-sm">
          <h2 className="font-serif text-2xl font-semibold text-foreground mb-6">Create account</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" size="lg" data-testid="button-sign-up">
              Create account
            </Button>
          </form>
